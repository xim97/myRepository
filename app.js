...
app.get('/articleId', (req, res) => res.json(articles.find(article => Number(req.query.id) === article.id)));
...
app.put('/article', (req, res) => {
  const articleIndex = articles.indexOf(article => Number(req.body.id) === article.id);
